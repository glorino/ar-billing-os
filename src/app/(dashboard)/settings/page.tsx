...
const teamMembers = [
  { name: "John Smith", email: "john@arbilling.com", role: "Admin", initials: "JS" },
  { name: "Sarah Johnson", email: "sarah@arbilling.com", role: "Manager", initials: "SJ" },
  { name: "Mike Williams", email: "mike@arbilling.com", role: "Agent", initials: "MW" },
];
        ...
        <div className="min-w-0">
          ...
          {activeTab === "general" && (
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="h-10 w-full rounded-lg border bg-background px-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/30"
                    />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="h-10 w-full rounded-lg border bg-background px-3 text-sm placeholder:text-muted-foreground/60 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/30"
                    />
                  </div>
                </div>
              ...
              {/* Invoice Defaults */}
              <div className="rounded-xl border bg-card p-6 card-elevated">
                <h3 className="text-base font-semibold mb-1">Invoice Defaults</h3>
                <p className="text-sm text-muted-foreground mb-6">Set default values for new invoices.</p>
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    <label className="text-sm font-medium">Payment Terms</label>
                    <select className="h-10 w-full rounded-lg border bg-background px-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/30">
          ...
          {activeTab === "billing" && (
            <div className="rounded-xl border bg-card p-6 card-elevated">
              <h3 className="text-base font-semibold mb-1">Payment Gateways</h3>
              <p className="text-sm text-muted-foreground mb-6">Configure your connected payment providers.</p>
              <div className="space-y-3">
                <div className="flex items-center justify-between p-4 rounded-xl border bg-card card-elevated-hover">
                ...
                <div className="flex items-center justify-between p-4 rounded-xl border bg-card card-elevated-hover">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold">ACH Transfer</p>
                      <p className="text-xs text-muted-foreground">Bank transfers</p>
                    </div>
                  </div>
                  <button className="inline-flex items-center gap-1.5 rounded-lg border bg-card px-3 py-1.5 text-xs font-medium text-foreground hover:bg-muted transition-colors">
                    Enable
                  </button>
                </div>
              </div>
          ...
          {activeTab === "notifications" && (
            <div className="rounded-xl border bg-card p-6 card-elevated">
              ...
              <p className="text-sm text-muted-foreground mb-6">Configure when to send email notifications.</p>
              <div className="space-y-2">
                {notifications.map((n, i) => (
                  <div key={i} className="flex items-center justify-between p-4 rounded-xl border bg-card card-elevated-hover">
                    <div>
          ...
          {activeTab === "security" && (
            <div className="space-y-6">
              ...
              <div className="rounded-xl border bg-card p-6 card-elevated">
                ...
                <div className="space-y-3">
                  <div className="p-4 rounded-xl border bg-card card-elevated-hover">
                    <div className="flex items-center justify-between mb-2">
                      <p className="text-sm font-medium">Production API Key</p>
                      <span className="inline-flex items-center rounded-full bg-success/10 px-2 py-0.5 text-[10px] font-semibold text-success">Active</span>
                    </div>
                    <input
                      type="password"
                  ...
                  <div className="p-4 rounded-xl border bg-card card-elevated-hover">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="inline-flex items-center rounded-full bg-muted px-2 py-0.5 text-[10px] font-semibold text-muted-foreground">Test</span>
                    </div>
                    <input
                      type="password"
            ...
            <div className="rounded-xl border bg-card p-6 card-elevated">
              ...
              <div className="space-y-3">
                {teamMembers.map((member) => (
                  <div key={member.email} className="flex items-center justify-between p-4 rounded-xl border bg-card card-elevated-hover">
                    <div className="flex items-center gap-3">
